...
import classes from './MonthsList.module.css.js';
...
const MonthsList = factory((_props, ref) => {
  ...
  const rows = months.map((monthsRow, rowIndex) => {
    ...
    return /* @__PURE__ */ React.createElement("tr", __spreadValues({ key: rowIndex }, getStyles("monthsListRow")), cells);
  });
  return /* @__PURE__ */ React.createElement(Box, __spreadValues(__spreadValues({ component: "table", ref, size }, getStyles("monthsList")), others), /* @__PURE__ */ React.createElement("tbody", null, rows));
});
