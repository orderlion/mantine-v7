...
function GithubControl({ link }) {
  return /* @__PURE__ */ React__default.createElement(HeaderControl.HeaderControl, { tooltip: "Source code", component: "a", href: link }, /* @__PURE__ */ React__default.createElement(GithubIcon.GithubIcon, { size: 22 }));
}
