...
import cx from 'clsx';
import { useModalTitle } from './use-modal-title-id.js';
...
const ModalBaseTitle = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(Box, __spreadProps(__spreadValues({ component: "h2", ref, className: cx(classes.title, className) }, others), { id }));
  }
);
