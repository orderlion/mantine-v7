...
import cx from 'clsx';
import { useModalBodyId } from './use-modal-body-id.js';
...
const ModalBaseBody = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(Box, __spreadProps(__spreadValues({ ref }, others), { id: bodyId, className: cx(classes.body, className) }));
  }
);
