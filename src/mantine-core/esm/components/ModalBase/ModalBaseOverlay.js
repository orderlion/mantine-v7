...
const ModalBaseOverlay = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(Transition, __spreadProps(__spreadValues({ mounted: ctx.opened }, transition), { transition: "fade" }), (transitionStyles) => /* @__PURE__ */ React.createElement(
      Overlay,
      __spreadValues({
        ref,
        fixed: true,
