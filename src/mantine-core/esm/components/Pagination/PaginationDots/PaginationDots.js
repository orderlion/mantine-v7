...
import { PaginationDotsIcon } from '../Pagination.icons.js';
...
const PaginationDots = factory((_props, ref) => {
  ...
  const Icon = icon;
  return /* @__PURE__ */ React.createElement(Box, __spreadValues(__spreadValues({ ref }, ctx.getStyles("dots", { className, style, styles, classNames })), others), /* @__PURE__ */ React.createElement(
    Icon,
    {
      style: {
