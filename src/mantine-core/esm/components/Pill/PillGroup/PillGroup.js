...
import { PillGroupProvider } from '../PillGroup.context.js';
...
const PillGroup = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(PillGroupProvider, { value: { size: _size, disabled } }, /* @__PURE__ */ React.createElement(Box, __spreadValues(__spreadValues({ ref, size: _size }, getStyles("group")), others)));
});
