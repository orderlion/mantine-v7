import { BoxProps, StylesApiProps, ElementProps, FactoryPayload, Factory } from '../../core';
import type { TableFactory } from './Table';
export interface TableElementProps<Selector extends string> extends BoxProps, StylesApiProps<Omit<TableFactory, 'stylesNames'> & {
