...
export interface StepperStepProps extends BoxProps, StylesApiProps<StepperStepFactory>, ElementProps<'button'> {
...
export declare const StepperStep: import("../../../core").MantineComponent<{
    props: StepperStepProps;
    ref: HTMLButtonElement;
    stylesNames: StepperStepStylesNames;
    compound: true;
