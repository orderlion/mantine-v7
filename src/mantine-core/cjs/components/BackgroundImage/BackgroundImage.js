...
var BackgroundImage_module = require('./BackgroundImage.module.css.js');
...
const varsResolver = createVarsResolver.createVarsResolver((_, { radius }) => ({
  root: { "--bi-radius": getSize.getRadius(radius) }
}));
const BackgroundImage = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  const getStyles = useStyles.useStyles({
    ...
    props,
    classes: BackgroundImage_module['default'],
    className,
    style,
    classNames,
    styles,
...
BackgroundImage.classes = BackgroundImage_module['default'];
