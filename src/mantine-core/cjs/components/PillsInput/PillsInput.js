...
var PillsInputField = require('./PillsInputField/PillsInputField.js');
...
const PillsInput = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(PillsInput_context.PillsInputProvider, { value: { fieldRef, size, disabled, hasError: !!error, variant } }, /* @__PURE__ */ React__default.createElement(
    InputBase.InputBase,
