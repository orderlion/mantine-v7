  ...
  (theme, { radius, color, gradient, variant, size }) => {
    ...
    return {
      root: {
        ...
        "--badge-radius": getSize.getRadius(radius),
...
const Badge = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(
    ...
    leftSection && /* @__PURE__ */ React__default.createElement("span", __spreadProps(__spreadValues({}, getStyles("section")), { "data-position": "left" }), leftSection),
    /* @__PURE__ */ React__default.createElement("span", __spreadValues({}, getStyles("label")), children),
    rightSection && /* @__PURE__ */ React__default.createElement("span", __spreadProps(__spreadValues({}, getStyles("section")), { "data-position": "right" }), rightSection)
  );
});
Badge.classes = Badge_module['default'];
