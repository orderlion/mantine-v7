...
const ActionIconGroup = factory.factory((_props, ref) => {
  ...
  const _a = useProps.useProps("ActionIconGroup", defaultProps, _props), {
    className,
    style,
    classNames,
    styles,
...
ActionIconGroup.classes = ActionIcon_module['default'];
ActionIconGroup.displayName = "@mantine/core/ActionIconGroup";

exports.ActionIconGroup = ActionIconGroup;
//# sourceMappingURL=ActionIconGroup.js.map
