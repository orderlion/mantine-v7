...
var Kbd_module = require('./Kbd.module.css.js');
...
const Kbd = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadValues(__spreadValues({ component: "kbd", ref }, getStyles("root")), others));
});
Kbd.classes = Kbd_module['default'];
