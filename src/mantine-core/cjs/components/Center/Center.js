...
var Center_module = require('./Center.module.css.js');
...
const defaultProps = {};
const varsResolver = createVarsResolver.createVarsResolver((_, { inline }) => ({
...
const Center = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  const _a = props, { classNames, className, style, styles, unstyled, vars, inline } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "unstyled", "vars", "inline"]);
  const getStyles = useStyles.useStyles({
    name: "Center",
    props,
    classes: Center_module['default'],
    className,
    style,
    classNames,
    styles,
...
Center.classes = Center_module['default'];
