...
var cx = require('clsx');
var useModalTitleId = require('./use-modal-title-id.js');
...
const ModalBaseTitle = React.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadProps(__spreadValues({ component: "h2", ref, className: cx__default(ModalBase_module['default'].title, className) }, others), { id }));
  }
);
