...
const ModalBaseContent = React.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement(
      ...
      (transitionStyles) => /* @__PURE__ */ React__default.createElement("div", __spreadProps(__spreadValues({}, innerProps), { className: cx__default(ModalBase_module['default'].inner, innerProps.className) }), /* @__PURE__ */ React__default.createElement(FocusTrap.FocusTrap, { active: ctx.opened && ctx.trapFocus }, /* @__PURE__ */ React__default.createElement(
        Paper.Paper,
        __spreadProps(__spreadValues({}, others), {
          ...
          className: cx__default(ModalBase_module['default'].content, className)
        }),
        others.children
      )))
    );
