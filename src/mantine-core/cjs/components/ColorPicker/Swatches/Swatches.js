...
const Swatches = React.forwardRef(
  (_a, ref) => {
    ...
    const colors = data.map((color, index) => /* @__PURE__ */ React__default.createElement(
    ...
    return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadValues(__spreadProps(__spreadValues({}, getStyles("swatches")), { ref }), others), colors);
  }
);
