...
var ThemeIcon_module = require('./ThemeIcon.module.css.js');
  ...
  (theme, { size, radius, variant, gradient, color }) => {
    ...
    return {
      root: {
        ...
        "--ti-radius": getSize.getRadius(radius),
...
const ThemeIcon = factory.factory((_props, ref) => {
  ...
  const getStyles = useStyles.useStyles({
    name: "ThemeIcon",
    classes: ThemeIcon_module['default'],
    props,
    className,
    style,
    classNames,
...
ThemeIcon.classes = ThemeIcon_module['default'];
