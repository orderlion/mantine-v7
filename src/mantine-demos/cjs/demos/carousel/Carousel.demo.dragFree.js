...
`;
function Demo() {
  return /* @__PURE__ */ React__default.createElement(carousel.Carousel, { withIndicators: true, height: 200, dragFree: true, slideGap: "md", align: "start" }, /* @__PURE__ */ React__default.createElement(_slides.Slides, { count: 5 }));
}
const dragFree = {
  type: "code",
  component: Demo,
