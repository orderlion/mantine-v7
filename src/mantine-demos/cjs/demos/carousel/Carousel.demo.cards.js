...
var Carousel_demo_cards_module = require('./Carousel.demo.cards.module.css.js');
...
function Card({ image, title, category }) {
  return /* @__PURE__ */ React__default.createElement(
    core.Paper,
    {
      ...
      radius: "md",
      style: { backgroundImage: `url(${image})` },
      className: Carousel_demo_cards_module['default'].card
    },
    /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement(core.Text, { className: Carousel_demo_cards_module['default'].category, size: "xs" }, category), /* @__PURE__ */ React__default.createElement(core.Title, { order: 3, className: Carousel_demo_cards_module['default'].title }, title)),
    /* @__PURE__ */ React__default.createElement(core.Button, { variant: "white", color: "dark" }, "Read article")
  );
}
function CarouselCardsDemos(props) {
  const theme = core.useMantineTheme();
  const mobile = hooks.useMediaQuery(`(max-width: ${theme.breakpoints.sm})`);
  const slides = data.map((item) => /* @__PURE__ */ React__default.createElement(carousel.Carousel.Slide, { key: item.title }, /* @__PURE__ */ React__default.createElement(Card, __spreadValues({}, item))));
  return /* @__PURE__ */ React__default.createElement(
    carousel.Carousel,
    __spreadValues({
      slideSize: { base: "100%", sm: "50%" },
...
exports.Card = Card;
exports.CarouselCardsDemos = CarouselCardsDemos;
exports.cards = cards;
