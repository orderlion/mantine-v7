...
function Wrapper(props) {
  return /* @__PURE__ */ React__default.createElement(carousel.Carousel, __spreadValues({ height: 200, slideSize: "70%" }, props), /* @__PURE__ */ React__default.createElement(_slides.Slides, { count: 5 }));
}
const code = `
