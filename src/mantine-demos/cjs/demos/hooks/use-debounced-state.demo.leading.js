...
`;
function Demo() {
  const [value, setValue] = hooks.useDebouncedState("", 200, { leading: true });
...
const useDebouncedStateLeading = {
  type: "code",
  component: Demo,
  code
};

exports.useDebouncedStateLeading = useDebouncedStateLeading;
//# sourceMappingURL=use-debounced-state.demo.leading.js.map
