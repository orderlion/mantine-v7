...
`;
const CustomButton = core.createPolymorphicComponent(
  React.forwardRef((_a, ref) => {
    var _b = _a, { label } = _b, others = __objRest(_b, ["label"]);
    return /* @__PURE__ */ React__default.createElement(core.Button, __spreadProps(__spreadValues({}, others), { ref }), label);
  })
);
const CustomButtonAnchor = core.createPolymorphicComponent(
  React.forwardRef((_c, ref) => {
    var _d = _c, { label } = _d, others = __objRest(_d, ["label"]);
    return /* @__PURE__ */ React__default.createElement(core.Button, __spreadProps(__spreadValues({ component: "a" }, others), { ref }), label);
  })
);
function Demo() {
  return /* @__PURE__ */ React__default.createElement(core.Group, null, /* @__PURE__ */ React__default.createElement(CustomButton, { label: "Button by default", color: "cyan" }), /* @__PURE__ */ React__default.createElement(CustomButtonAnchor, { label: "Anchor by default", href: "https://mantine.dev", target: "_blank" }));
}
...
exports.createPolymorphic = createPolymorphic;
