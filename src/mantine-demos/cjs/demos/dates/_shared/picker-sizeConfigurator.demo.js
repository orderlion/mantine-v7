...
function getDemo(Component) {
  return (props) => /* @__PURE__ */ React__default.createElement(Component, __spreadValues({ defaultValue: /* @__PURE__ */ new Date() }, props));
}
...
exports.getPickerSizeConfiguratorDemo = getPickerSizeConfiguratorDemo;
