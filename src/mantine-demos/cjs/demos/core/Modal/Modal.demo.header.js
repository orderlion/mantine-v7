...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(core.Modal, { opened, onClose: close, withCloseButton: false }, "Modal without header, press escape or click on overlay to close"), /* @__PURE__ */ React__default.createElement(core.Button, { onClick: open }, "Open Modal"));
}
const header = {
  type: "code",
  code,
