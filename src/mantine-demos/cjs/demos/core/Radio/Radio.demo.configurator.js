...
function Wrapper(props) {
  return /* @__PURE__ */ React__default.createElement(core.Radio.Group, { name: "demo", defaultValue: "react" }, /* @__PURE__ */ React__default.createElement(core.Radio, __spreadValues({ value: "react" }, props)));
}
const configurator = {
  type: "configurator",
  component: Wrapper,
