...
function Demo() {
  return /* @__PURE__ */ React__default.createElement(core.TypographyStylesProvider, null, /* @__PURE__ */ React__default.createElement("div", { dangerouslySetInnerHTML: { __html: html } }));
}
const all = {
  type: "code",
  component: Demo
...
exports.all = all;
//# sourceMappingURL=TypographyStylesProvider.demo.all.js.map
