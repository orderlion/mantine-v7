...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(core.Drawer, { opened, onClose: close, title: "Focus demo" }, /* @__PURE__ */ React__default.createElement(core.TextInput, { label: "First input", placeholder: "First input" }), /* @__PURE__ */ React__default.createElement(
    core.TextInput,
    {
      "data-autofocus": true,
      label: "Input with initial focus",
