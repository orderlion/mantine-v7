...
function Demo() {
  return (
    <ColorPicker{{props}} format="hex" swatches={[${Object.keys(core.DEFAULT_THEME.colors).map((color) => `'${core.DEFAULT_THEME.colors[color][6]}'`).join(", ")}]} />
  );
}
`;
...
exports.swatchesConfigurator = swatchesConfigurator;
