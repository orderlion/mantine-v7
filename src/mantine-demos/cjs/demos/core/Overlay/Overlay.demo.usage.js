...
function Demo() {
  ...
  ), visible && /* @__PURE__ */ React__default.createElement(core.Overlay, { color: "#000", backgroundOpacity: 0.85 })), /* @__PURE__ */ React__default.createElement(core.Button, { onClick: () => setVisible((v) => !v), fullWidth: true, maw: 200, mx: "auto", mt: "xl" }, "Toggle overlay"));
}
const usage = {
  type: "code",
  code,
