...
var Styles_demo_dataAttributes_module = require('./Styles.demo.dataAttributes.module.css.js');
...
function SendFilesButton(props) {
  return /* @__PURE__ */ React__default.createElement(core.Button, __spreadProps(__spreadValues({}, props), { radius: "md", classNames: Styles_demo_dataAttributes_module['default'] }));
}
function Demo() {
  return /* @__PURE__ */ React__default.createElement(core.Group, null, /* @__PURE__ */ React__default.createElement(
    SendFilesButton,
    {
      leftSection: "12",
      rightSection: /* @__PURE__ */ React__default.createElement(iconsReact.IconArrowRight, { style: { width: core.rem(18) } })
    },
    "Send files"
