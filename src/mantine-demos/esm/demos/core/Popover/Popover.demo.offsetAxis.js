...
function Wrapper(props) {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Popover.Target, null, /* @__PURE__ */ React.createElement(Button, null, "Popover target")),
    /* @__PURE__ */ React.createElement(Popover.Dropdown, null, /* @__PURE__ */ React.createElement(Text, { size: "xs" }, "Change position and offset to configure dropdown offset relative to target"))
  );
}
const offsetAxis = {
  type: "configurator",
