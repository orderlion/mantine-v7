...
function Demo() {
  const [active, { toggle }] = useDisclosure(false);
  return /* @__PURE__ */ React.createElement(Box, { maw: 400, mx: "auto" }, /* @__PURE__ */ React.createElement(Button, { onClick: toggle }, active ? "Deactivate" : "Activate", " focus trap"), /* @__PURE__ */ React.createElement(FocusTrap, { active }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(TextInput, { mt: "sm", label: "First input", placeholder: "First input" }), /* @__PURE__ */ React.createElement(TextInput, { mt: "sm", label: "Second input", placeholder: "Second input" }), /* @__PURE__ */ React.createElement(TextInput, { mt: "sm", label: "Third input", placeholder: "Third input" }))));
}
const usage = {
  type: "code",
  component: Demo,
...
export { usage };
//# sourceMappingURL=FocusTrap.demo.usage.js.map
