...
import classes from './CssLoader.module.css.js';
...
const CssLoader = forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, others = __objRest(_b, ["className"]);
  return /* @__PURE__ */ React.createElement(Box, __spreadProps(__spreadValues({ component: "span", className: cx(classes.loader, className) }, others), { ref }));
});
...
export { CssLoader, cssLoaderModuleCssCode, cssLoaderTsxCode };
