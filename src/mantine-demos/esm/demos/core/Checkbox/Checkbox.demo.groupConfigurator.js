...
function Wrapper(props) {
  return /* @__PURE__ */ React.createElement(Checkbox.Group, __spreadValues({ defaultValue: ["react"] }, props), /* @__PURE__ */ React.createElement(Group, { mt: "xs" }, /* @__PURE__ */ React.createElement(Checkbox, { value: "react", label: "React" }), /* @__PURE__ */ React.createElement(Checkbox, { value: "svelte", label: "Svelte" }), /* @__PURE__ */ React.createElement(Checkbox, { value: "ng", label: "Angular" }), /* @__PURE__ */ React.createElement(Checkbox, { value: "vue", label: "Vue" })));
}
