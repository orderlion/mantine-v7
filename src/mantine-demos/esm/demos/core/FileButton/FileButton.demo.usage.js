...
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Group, { justify: "center" }, /* @__PURE__ */ React.createElement(FileButton, { onChange: setFile, accept: "image/png,image/jpeg" }, (props) => /* @__PURE__ */ React.createElement(Button, __spreadValues({}, props), "Upload image"))), file && /* @__PURE__ */ React.createElement(Text, { size: "sm", ta: "center", mt: "sm" }, "Picked file: ", file.name));
}
const usage = {
  type: "code",
  component: Demo,
