...
import classes from './Slider.demo.customize.module.css.js';
...
`;
function Demo() {
  return /* @__PURE__ */ React.createElement(Box, { maw: 400, pt: 15, pb: 20, mx: "auto" }, /* @__PURE__ */ React.createElement(
    Slider,
    {
      defaultValue: 40,
      marks: [
