...
`;
function Demo() {
  return /* @__PURE__ */ React.createElement(Box, { maw: 560, mx: "auto" }, /* @__PURE__ */ React.createElement(TypographyStylesProvider, null, /* @__PURE__ */ React.createElement("div", { dangerouslySetInnerHTML: { __html: html } })));
}
const usage = {
  type: "code",
  code,
