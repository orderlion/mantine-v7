...
import { AddressBookIcon } from './_CustomIcon.js';
...
`;
function Demo() {
  return /* @__PURE__ */ React.createElement(Button, { leftSection: /* @__PURE__ */ React.createElement(AddressBookIcon, { size: 18 }) }, "Demo");
}
const customIcon = {
  type: "code",
  component: Demo,
