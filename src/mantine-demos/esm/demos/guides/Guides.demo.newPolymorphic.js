...
import { createPolymorphicComponent, Box, Group } from '@mantine/core';
...
`;
const MyButton = createPolymorphicComponent(
  forwardRef((_a, ref) => {
    var _b = _a, { label } = _b, others = __objRest(_b, ["label"]);
    return /* @__PURE__ */ React.createElement(Box, __spreadProps(__spreadValues({ component: "button" }, others), { ref }), label);
  })
);
function Demo() {
  return /* @__PURE__ */ React.createElement(Group, null, /* @__PURE__ */ React.createElement(MyButton, { label: "Button by default" }), /* @__PURE__ */ React.createElement(
    MyButton,
    {
      label: "MyButton as anchor",
      component: "a",
