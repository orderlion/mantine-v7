...
import classes from './Styles.demo.dataAttributes.module.css.js';
...
`;
function SendFilesButton(props) {
  return /* @__PURE__ */ React.createElement(Button, __spreadProps(__spreadValues({}, props), { radius: "md", classNames: classes }));
}
function Demo() {
  return /* @__PURE__ */ React.createElement(Group, null, /* @__PURE__ */ React.createElement(
    SendFilesButton,
    {
      leftSection: "12",
      rightSection: /* @__PURE__ */ React.createElement(IconArrowRight, { style: { width: rem(18) } })
    },
    "Send files"
...
//# sourceMappingURL=Styles.demo.dataAttributes.js.map
