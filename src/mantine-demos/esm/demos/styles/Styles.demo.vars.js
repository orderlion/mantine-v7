...
function Demo() {
  return /* @__PURE__ */ React.createElement(Group, null, /* @__PURE__ */ React.createElement(Button, { vars: varsResolver, size: "xxl" }, "XXL Button"), /* @__PURE__ */ React.createElement(Button, { vars: varsResolver, size: "xxs" }, "XXS Button"));
}
const vars = {
  type: "code",
  component: Demo,
